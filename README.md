...
<img src="readme_images/ios_app_running.png" height="200px">
...
Android applications at the same time:
...
3. Re-run both the `androidApp` and `iosApp` configurations. You'll see this change reflected in
   both the Android and iOS apps:
